...
const benefitProposal = new ProposalGenerator({
  ...
  middleSentences: [
    ...
    'que concede auxílio-iPhone para',
  ...
  finalSentences: [
    ...
    'servidores públicos',
    'terraplanistas',
    'trabalhadores de funerárias',
    'usuários da Apple',
    'usuários da Xiaomi',
    'veganos',
    'viciados em BBB',
    'viciados em Minecraft',
    'viciados em Twitter',
    'viciados em futebol',
    'vigilantes',
    'vítimas de COVID-19',
...
const prohibitionProposal = new ProposalGenerator({
  ...
  middleSentences: [
    ...
    'a instalação de som automotivo',
...
const permissionProposal = new ProposalGenerator({
  initialSentences: ['Permitir', 'Incentivar', 'Obrigar', 'Subsidiar', 'Estimular', 'Encorajar'],
  middleSentences: [
    ...
    'a volta do Orkut',
    'a volta do RBD',
    'o retorno do One Direction',
    'o retorno do Silverchair',
    'o retorno do Pink Floyd',
    'jogo do bicho',
    'o congelamento do preço de sushi',
    'o consumo de Cloroquina',
    'o consumo de maconha',
    'o consumo de pastel com caldo de cana',
